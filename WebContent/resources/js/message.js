function Message() {
	...
	this.PLS_SELECT_RESET_DATA = "请选择要重置密码的用户！";
	...
	this.PLS_SELECT_FILE = "请选择要上传的文件！";
	...
	this.DELETE_CONFIRM = "您确定要删除所选的数据吗？";
	this.NO_VERSION = "无法获取数据版本信息！";
	this.VERSION_CHANGED = "业务数据已被其他人修改，请重新查询后再操作！"
	// 错误信息
