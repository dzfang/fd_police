...
<body class="easyui-layout">
	<div class="minWidth" style="padding: 5px;" region="north"
		...
		<form id="queryForm">
			<table class="t1">
				<tr>
					<th>发送人：</th>
					<td><cx:CXTeacherCombo id="createUser" name="createUser"
							width="150px"></cx:CXTeacherCombo></td>
			...
			<input type="hidden" id="reciverDelete" name="reciverDelete"
				value="0">
		</form>
	</div>
			...
			<thead>
				<tr>
					...
					<th field="operate" width="15%"
						data-options="align:'center',formatter:reciveFormatter">操作</th>
				</tr>
			</thead>
		</table>
		<div id="toolbar">
			<c:if test="${cx:permission(action, 'read')}">
				<a href="javascript:void(0);" id="btnRead"
	...
	<script type="text/javascript">
		var canRead = "${cx:permission(action, 'read')}";
