...
<body>
	<div class="easyui-layout" data-options="fit:true">
		<div class="" region="center" style="padding: 5px;" border="false">
			<form id="saveForm" action="<%=contextPath%>/employee/importExcel.do"
				method="post" enctype="multipart/form-data">
				<table class="t1">
					<tr>
						<th>文件路径：</th>
						<td><input type="file" id="file" name="file"
							accept="application/vnd.ms-excel" style="width: 447px;height: 35px; line-height: 35px;" /></td>
					</tr>
				</table>
			</form>
		</div>
		<div region="south" style="text-align: right; padding: 5px;"
			...
			<a href="javascript:void(0);" style="padding: 0px 10px;"
				...
				onclick="$('#saveForm').submit();" class="easyui-linkbutton c0"
