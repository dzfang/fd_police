		...
		<form id="queryForm">
			<div class="conditions" style="padding: 5px;">
				<span class="con-span">案卷编号 </span><input id="caseCode"
					...
					id="btnMore">更多</a> <a
					href="<%=contextPath%>/inspection/downloadTemplate.do"
					id="btnDownLoad" style="display: none;">下载模板</a>
			</div>
			<input type="hidden" id="caseType" name="caseType" value="${record.caseType}" /> <input
				type="hidden" id="relatedThings" name="relatedThings" value="${record.relatedThings}" /> <input type="hidden"
				id="caseAttr" name="caseAttr" /> <input type="hidden"
				id="caseLink" name="caseLink" /><input type="hidden"
				id="punishDoc" name="punishDoc" /><input type="hidden"
